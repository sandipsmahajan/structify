...
export default async function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
      <DiamondCard glow className="w-full max-w-md p-8 text-center">
        <div className="mb-8">
        ...
        <div className="space-y-3">
          ...
          >
            <DiamondButton variant="secondary" className="w-full justify-center gap-3" type="submit">
        ...
        <p className="mt-6 text-xs text-bd-text-muted">
